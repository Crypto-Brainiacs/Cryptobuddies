 ...
 * controlled by a central SupplyController. By implementing CBAImplementation
...
contract Cryptobuddies {
    ...
    string public constant name = "Crypto Buddies Assets"; // solium-disable-line
    string public constant symbol = "CBA"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all CBA at the contract address.
     * This sends the CBA tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimCBA() external onlyOwner {
